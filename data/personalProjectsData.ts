...
export const personalProjectsData: Project[] = [
    {
        ...
        slug: "az-trails-guide-mobile-app",
        description: "This is the az trails guide description detail",
        coverImage: "/images/az-trails-guide.png",
        details: {
            images: [], // TODO: Update content before deploy Adjust data points with the tech used, etc.
            techNotes: [
                {
                    title: "Front End",
    ...
    },
    {
        ...
        type: "personal-projects",
        title: "Threadly",
        slug: "threadly-web-app",
        description: "This is the threadly  description detail",
        coverImage: "/images/threadly.png",
        details: {
            images: [],
            techNotes: [
                {
